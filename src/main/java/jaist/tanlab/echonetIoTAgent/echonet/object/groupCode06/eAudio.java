 ...
 * the License.
 ******************************************************************************/
package jaist.tanlab.echonetIoTAgent.echonet.object.groupCode06;
...
import jaist.tanlab.echonetIoTAgent.echonet.object.utils.eConverter.AudioInput;
...
public class eAudio extends eDataObject{
	...
	public boolean setVolume(int volumePercetage) {
		...
		if(getVolumeSetting() == volumePercetage) {
			...
			if(this.cmdExecutor.executeCommand(this.getNode(),this.getEoj(),EPC.xB8, new ObjectData((byte) volumePercetage))) {
	...
	public boolean setMute(boolean mute) {
		...
		if(isMuteSetting() == mute) {
			...
			if(this.cmdExecutor.executeCommand(this.getNode(),this.getEoj(),EPC.xB9, new ObjectData(mute?(byte)0x30:(byte)0x31))) {
