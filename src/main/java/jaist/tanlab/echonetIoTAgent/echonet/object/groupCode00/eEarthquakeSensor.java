...
public class eEarthquakeSensor extends eDataObject{
	...
	public boolean resetEarthquakeOccurrenceStatus() {
		...
		if(!isEarthquakeOccurrenceStatus()) {
			...
			if(this.cmdExecutor.executeCommand(this.getNode(),this.getEoj(),EPC.xBF, new ObjectData((byte)0x00))) {
	...
	public boolean resetSIValue() {
		...
		if(getSiValue() == 0) {
			...
			if(this.cmdExecutor.executeCommand(this.getNode(),this.getEoj(),EPC.xC1, new ObjectData((byte)0x00))) {
				refreshSiValue(0.0f);
				rs= true;
			} else {
				rs = false;
	...
	public boolean resetCollapseOccurrenceStatus() {
		...
		if(!isCollapseOccurrenceStatus()) {
			...
			if(this.cmdExecutor.executeCommand(this.getNode(),this.getEoj(),EPC.xC3, new ObjectData((byte)0x00))) {
