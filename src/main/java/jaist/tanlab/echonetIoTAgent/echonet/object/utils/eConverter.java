...
public class eConverter {
	...
	public static String toNgsiID(String nodeIP, EOJ eoj, eDeviceType deviceType) {
		String rs = String.format("%s-%s-%s-%s", 
				SampleConstants.NGSI_PREFIX, deviceType.getName(),nodeIP,eoj.toString()).toString();
		return rs;
		
	}
	public static String deviceTypeFromNgsiID(String ngsiID) {
		String id = ngsiID.substring(SampleConstants.NGSI_PREFIX.length()+1);
		return id.split("-")[0];
		
	}
	public static String nodeIPFromNgsiID(String ngsiID) {
		String id = ngsiID.substring(SampleConstants.NGSI_PREFIX.length()+1);
		return id.split("-")[1];
		
	}
	public static String eojFromNgsiID(String ngsiID) {
		String id = ngsiID.substring(SampleConstants.NGSI_PREFIX.length()+1);
		return id.split("-")[2];
		
	}
	public static String toNgsiRegistrationID(String nodeIP, EOJ eoj, eDeviceType deviceType) {
		String rs = String.format("%s-%s-%s-%s", 
				SampleConstants.NGSI_REGISTRATION_PREFIX, deviceType.getName(),nodeIP,eoj.toString()).toString();
		return rs;
		
	}
	public static String deviceTypeFromNgsiRegistrationID(String ngsiID) {
		String id = ngsiID.substring(SampleConstants.NGSI_REGISTRATION_PREFIX.length()+1);
		return id.split("-")[0];
		
	}
	public static String nodeIPFromNgsiRegistrationID(String ngsiID) {
		String id = ngsiID.substring(SampleConstants.NGSI_REGISTRATION_PREFIX.length()+1);
		return id.split("-")[1];
		
	}
	public static String eojFromNgsiRegistrationID(String ngsiID) {
		String id = ngsiID.substring(SampleConstants.NGSI_REGISTRATION_PREFIX.length()+1);
		return id.split("-")[2];
	...
	public static String dataToCoordinator(ResultData data) {
		byte[] allData = data.toBytes();
		Byte firstByte =  Byte.valueOf(allData[0]);
		Byte secondByte = Byte.valueOf(allData[1]);
		Byte thirdByte =  Byte.valueOf(allData[2]);
